...
function iniciarApp(){
    ...
    tabs(); // Cambia la seccion cuando se presiona un tab
...
function mostrarSeccion(){
    ...
    // Ocultar la seccion que no tenga la clase actual
...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true){
    // Previene que se generen mas de un alerta
...
async function reservarCita(){
    ...
    if(resultado.resultado){
        Swal.fire({
            ...
            text: 'El turno fue reservado correctamente',
            button: 'OK'
          }).then(() => {
            setTimeout(() => {
